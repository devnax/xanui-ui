...
export type BadgeProps<T extends TagComponentType = "div"> = Omit<
  TagProps<T>,
  "baseClass" | "content"
> & {
  content?: useBreakpointPropsType<number | string | ReactElement>;
  color?: useBreakpointPropsType<UseColorTemplateColor>;
  placement?: useBreakpointPropsType<
...
const Badge = React.forwardRef(
  <T extends TagComponentType = "div">(
    { children, content, refs, ...rest }: BadgeProps<T>,
    ref: React.Ref<any>,
  ) => {
    let [
      {
    ...
    ] = useThemeComponent<any>("Badge", rest, {});
    color ??= "danger";
    visible ??= true;
    placement ??= "right-top";
            ...
            variant={(ele: HTMLElement) => {
              return {
                ...
                onUpdate: ({ opacity, transform }: any) => {
                  ...
                  ele.style.transform = `${transform}`.trim();
                },
              };
            }}
            ref={refs?.transition}
