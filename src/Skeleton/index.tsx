...
const Skeleton = React.forwardRef(
  <T extends TagComponentType = "div">(
    { children, loading, color, animation, ...props }: SkeletonProps<T>,
    ref: React.Ref<any>,
  ) => {
    ...
    if (loading) {
        ...
        case "wave":
          sxr = {
            ...
            "&::after": {
              ...
              background: `linear-gradient(90deg, transparent 0%, var(--color-paper-secondary) 50%, transparent 100%)`,
            },
            "@keyframes skwave": {
              "0%": { left: "-100%" },
              "100%": { left: "100%" },
      ...
      return <Tag {...props} baseClass="skeleton" ref={ref} sxr={sxr} />;
    }
