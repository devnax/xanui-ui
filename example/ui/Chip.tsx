...
const ChipBox = ({ color }) => {
   return (
      <Section title={color} gap={2} flexRow alignItems="center">
         <Chip size="small" color={color} variant="fill" label="Active" />
         <Chip size="medium" color={color} variant="outline" label="Deactive" />
         <Chip size="large" color={color} variant="ghost" label="Panding" />
