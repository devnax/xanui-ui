   ...
   return (
      <Stack gap={2} width={400}>
         ...
         <Section title="Size" gap={2}>
            <Input size="small" endIcon={<SendIcon />} />
            <Input size="medium" endIcon={<SendIcon />} />
            <Input size="large" endIcon={<SendIcon />} />
         </Section>
         <Section title="Error" gap={2}>
            <Input size="small" endIcon={<SendIcon />} error />
            <Input
               size="medium"
               endIcon={<SendIcon />}
               error
         ...
         <Section title="Disabled" gap={2}>
            <Input size="medium" endIcon={<SendIcon />} disabled />
         </Section>
