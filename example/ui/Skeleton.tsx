...
const Skeletons = () => {
   ...
   return (
      <Stack>
         <Section title="Basic">
            <Stack p={2} gap={2} borderColor='surface.divider' radius={1} overflow="hidden" maxWidth={600}>
               <Skeleton animation={"wave"} color="surface" height={16} radius={2} loading={true} >
                  <Stack p={2} gap={1}>
