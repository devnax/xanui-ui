...
const Colored = () => {
  return (
    <Section title="Colors" gap={2} flexRow>
      <CircleProgress color="default" />
      <CircleProgress color="brand" />
      <CircleProgress color="accent" />
      <CircleProgress color="info" />
      <CircleProgress color="success" />
      <CircleProgress color="warning" />
      <CircleProgress color="danger" />
    </Section>
  );
};
...
const ColoredLineProgress = () => {
  return (
    <Section title="Colors" gap={2}>
      <LineProgress color="default" />
      <LineProgress color="brand" />
      <LineProgress color="accent" />
      <LineProgress color="info" />
      <LineProgress color="success" />
      <LineProgress color="warning" />
      <LineProgress color="danger" />
    </Section>
  );
};
  ...
  return (
    <Container maxWidth="md">
      <Section title="Basic" gap={2} flexRow>
        ...
        <CircleProgress color="accent" size={40} />
      </Section>
      <Colored />
      <Section title="Size" gap={2} flexRow>
        <CircleProgress size={"sm"} />
        <CircleProgress size={"md"} />
        <CircleProgress size={"xl"} />
      </Section>
      <Section title="Thumb Size" gap={2} flexRow>
        <CircleProgress thumbSize={9} trackSize={4} />
      </Section>
